...
@section('content')
    ...
    {!! Form::open(['route' => 'abono_ctaxcobrar', 'class' => 'form']) !!}
        <div class="row">
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-6 col-md-4 col-lg-4">
            ...
            {!! Form::text('apellidos', '', ['class'=> 'form-control', 'ReadOnly'=>'true']) !!}
        </div>
    </div>
    <hr/>
    <div class="row">
...
@section('script')
    <script>
        function Buscar() {
             ...
             */
            $.ajax({
                url : '/CuentasFacturas/abono_ctaxcobrar_ajax/'+identificacion,
                type:'GET',
                dataType: 'json',
                success:function(r)
                {
